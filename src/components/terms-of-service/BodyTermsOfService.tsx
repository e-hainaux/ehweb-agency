    ...
    <section className={styles.mainContainer}>
      ...
      <article className={styles.article}>
        ...
        <p className={styles.paragraph}>
          {`Le présent site, accessible à l’URL www.ehweb.fr (le « Site »), est édité par Emilien Hainaux, résidant 6 rue Pasteur 62217 Achicourt, de nationalité Française (France), né(e) le 12/10/1982. (Numéro SIRET en cours de délivrance).`}
        </p>
      </article>
      <Splitter />
      <article className={styles.article}>
